...
// Problem 1
  //tell each person their t-shirt size
  forEach
  
  let shirtSize = [];
runners.forEach(function(element) {
  if runners.id >= 0;
  fullName.push(element.first_name, element.last_name.join(" "));
}
  
console.log(fullName);
"Hi Joe you are getting a size ${shirt_size} t-shirt"

// Problem 2
//find people who donated more than $200
// Problem 3
  //find people who donated less than the average amount
